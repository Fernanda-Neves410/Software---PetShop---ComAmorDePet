...
//    @SuppressWarnings("unchecked")
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        ...
                        .addComponent(jTextFieldTelefone, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 94, Short.MAX_VALUE)))
    ...
    private void jButtonSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonSalvarActionPerformed
        ...
        if (clicpf.length() < 14) {
            ComAmorDePetApp.mostraMensagem("CPF inválido!"
                    + "\nPreencha corretamente!", "Cadastro do Cliente");
        } else if (clinome.length() < 1) {
            ComAmorDePetApp.mostraMensagem("Nome inválido!"
                    + "\nO nome deve possuir pelo menos 1 letra."
                    + "\nPreencha corretamente!", "Cadastro do Cliente");
        } else {
            Cliente cliente = ComAmorDePetApp.controle.buscarClienteCpf(clicpf);
            if (cliente == null) {

                cliente = new Cliente(clicpf, clinome);
                ...
                ComAmorDePetApp.mostraMensagem("O Cliente '" + cliente.getNome() + "' "
                        + "foi cadastrado com sucesso!", "Cadastro do Cliente");
            } else {

                ComAmorDePetApp.mostraMensagem("CPF já cadastrado!", "Cadastro do Cliente");
            }
